...
function Content() {
  return (
    <>
      ...
      <BlogImage
        src="/blog/bulk-builder.png"
        alt="The Bulk Builder: a spreadsheet-style grid of rows with source and medium dropdowns, generated URLs, projects, and a Copy All URLs button"
        width={2000}
        height={1578}
        caption="The Bulk Builder: a spreadsheet-style grid with dropdowns, saved projects, generated URLs, and one-click CSV export."
      />
    </>
  );
}
